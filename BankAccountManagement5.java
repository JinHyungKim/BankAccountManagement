...
class ShinhanBank extends Client implements MakingBankAccount{
	...
	public void setAccount(){
		...
		bankAccount = (new StringBuilder(String.valueOf(bankSerialNumber)).append("-").append(fourteen_format.format(date_now)).append(rand.nextInt(10))).toString();
	}
}
			...
			try{
				...
				case 1:
					...
					for(Client c : clientDatabase){
						// System.out.println(Client.getPasswordHashing(trialPw));	
